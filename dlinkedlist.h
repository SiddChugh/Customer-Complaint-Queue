...
public:
  ...
  /**
    ...
    *PARAM: item = item to be inserted, p = position where item will be 
    *inserted
    */
  ...
  /**
    *Removes duplicates from the list, preserving existing order of remaining 
    *items.
    *The first occurrence of any duplicate (relative to the front of the list)
    *  is the one which remains.
    *We have not yet learned about efficiency so you may implement this in any 
    *way as long as the resulting list satisfies the requirement above.
    *PRE:   
